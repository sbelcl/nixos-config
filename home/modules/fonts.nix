{config, pkgs, ...}: {
  ...
  # GTK and kdeglobals colours are generated by matugen, which is imported
  # per-host — including the @import that pulls them into the gtk.css written
  # here. See matugen.nix. Without it this file's plain adw-gtk3-dark/Breeze
  # palettes stand on their own.
