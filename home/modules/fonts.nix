{config, pkgs, ...}: {
  ...
  # GTK and kdeglobals colours are generated by matugen, which is flanker-only
  # — including the @import that pulls them into the gtk.css written here.
  # See matugen.nix; fulcrum keeps the plain adw-gtk3-dark/Breeze palettes.
